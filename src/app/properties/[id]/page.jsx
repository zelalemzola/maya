...
export default function PropertyDetails({ params }) {
  ...
  return (
    <div className="container mx-auto p-4 space-y-8">
      <Button variant="ghost" onClick={() => router.back()} className="mb-4 text-lg">
        <ArrowLeftCircle className="mr-2 h-8 w-8" /> Back to listings
      </Button>

      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <Carousel className="w-full max-w-xl">
            <CarouselContent className='bg-zinc-600'>
            ...
            <CarouselPrevious className='bg-zinc-600 text-secondary'/>
            <CarouselNext className='bg-zinc-600 text-secondary'/>
          </Carousel>
        </div>
